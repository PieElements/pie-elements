...
const OpenIcon = () => <svg preserveAspectRatio="xMinYMin meet" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="-283 359 34 35" style={{ enableBackground: 'new -283 359 34 35' }}>
  <g>
    <g>
      <g>
        <g>
...
const CloseIcon = () => <svg preserveAspectRatio="xMinYMin meet" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="-129.5 127 34 35" style={{ enableBackground: 'new -129.5 127 34 35' }}>
...
const CorrectResponse = ({ open, classes, className }) => <div className={classNames(className, classes.root)}>{open ? <OpenIcon /> : <CloseIcon />}</div>;
